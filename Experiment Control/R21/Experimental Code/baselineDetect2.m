...
for sessi = 1:length(dir_content)-1
    ...
    % feedback
    disp(['Completed with ',ratName,' session ',num2str(sessi)])
...
mkdir(['X:\01.Experiments\R21\' ratName,'\baseline alternative'])
cd(['X:\01.Experiments\R21\' ratName,'\baseline alternative'])
