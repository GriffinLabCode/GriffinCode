...
%% CHANGE ME - 8 PLACE TO CHANGE
targetRat = '21-8';  % CHANGE ME

% 21-1
LFP1name = 'HPC_clear';  % HPC     % change me
LFP2name = 'PFC_red'; % PFC       % change me
...
params.Fs      = srate;
params.fpass   = [4 12];
params.tapers  = [3 5]; % if forgot this its okay bc its automatically set to 3 5
...
cd('X:\01.Experiments\R21\Code\Thresholds')
