%NLXGETNEWTTDATA   Gets new TT records that have been streamed over netcom
%
%   [succeeded, dataArray, timeStampArray, spikeChannelNumberArray, cellNumberArray, featureArray, numRecordsReturned, numRecordsDropped ] = NlxGetNewTTData(objectName)
%
%   Example:   [succeeded, dataArray, timeStampArray, spikeChannelNumberArray, cellNumberArray, featureArray, numRecordsReturned, numRecordsDropped ] = NlxGetNewSTData('TT1')
%		Returns the data for all the records received for TT1 since the last call to this function.	
%
%	Returns:
...
function [succeeded, dataArray, timeStampArray, spikeChannelNumberArray, cellNumberArray, featureArray, numRecordsReturned, numRecordsDropped ] = NlxGetNewTTData(objectName) 
	...
	[succeeded, objectName, timeStampArray, spikeChannelNumberArray, cellNumberArray,featureArray, dataArray, numRecordsReturned, numRecordsDropped ] = calllib('MatlabNetComClient', 'GetNewTTData', objectName, timeStampArrayPtr, spikeChannelNumberArrayPtr, cellNumberArrayPtr, featureArrayPtr, dataArrayPtr, numRecordsReturnedPtr,numRecordsDroppedPtr );
