%NLXGETNEWSEDATA   Gets new SE records that have been streamed over NetCom
%
%   [succeeded, dataArray, timeStampArray, spikeChannelNumberArray, cellNumberArray, featureArray, numRecordsReturned, numRecordsDropped ] = NlxGetNewSEData(objectName)
%
%   Example:   [succeeded, dataArray, timeStampArray, spikeChannelNumberArray, cellNumberArray, featureArray, numRecordsReturned, numRecordsDropped ] = NlxGetNewSEData('SE1')
%		Returns the data for all the records received for SE1 since the last call to this function.	
%
%	Returns:
...
function [succeeded, dataArray, timeStampArray, spikeChannelNumberArray, cellNumberArray, featureArray, numRecordsReturned, numRecordsDropped ] = NlxGetNewSEData(objectName) 
	...
	[succeeded, objectName, timeStampArray, spikeChannelNumberArray, cellNumberArray,featureArray, dataArray, numRecordsReturned, numRecordsDropped ] = calllib('MatlabNetComClient', 'GetNewSEData', objectName, timeStampArrayPtr, spikeChannelNumberArrayPtr, cellNumberArrayPtr, featureArrayPtr, dataArrayPtr, numRecordsReturnedPtr,numRecordsDroppedPtr );
