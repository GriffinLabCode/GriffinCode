...
function [succeeded, dataArray, timeStampArray, channelNumberArray, samplingFreqArray, numValidSamplesArray, numRecordsReturned, numRecordsDropped , funDur] = NlxGetNewCSCData_2signals(objectName1, objectName2)  
    ...
    if (numRecordsReturned_signal2 ~= numRecordsReturned_signal1) && (numRecordsReturned_signal2 > numRecordsReturned_signal1) 
        disp('Error in sampling signal 1')
        [succeeded_signal1a, objectName_signal1a, timeStampArray_signal1a, channelNumberArray_signal1a, samplingFreqArray_signal1a, numValidSamplesArray_signal1a, dataArray_signal1a, numRecordsReturned_signal1a, numRecordsDropped_signal1a ] = calllib('MatlabNetComClient', 'GetNewCSCData', objectName1, timeStampArrayPtr, channelNumberArrayPtr, samplingFreqArrayPtr, numValidSamplesArrayPtr, dataArrayPtr, numRecordsReturnedPtr,numRecordsDroppedPtr );
        timeStampArray_signal1     = [timeStampArray_signal1, timeStampArray_signal1a];
        samplingFreqArray_signal1  = [samplingFreqArray_signal1, samplingFreqArray_signal1a];
        dataArray_signal1          = [dataArray_signal1, dataArray_signal1a];
        numRecordsReturned_signal1 = [numRecordsReturned_signal1+numRecordsReturned_signal1a]; 
        numRecordsDropped_signal1  = [numRecordsDropped_signal1+numRecordsDropped_signal1a];  
        
    elseif (numRecordsReturned_signal2 ~= numRecordsReturned_signal1) && (numRecordsReturned_signal2 < numRecordsReturned_signal1) 
        disp('Error in sampling signal 2')
        [succeeded_signal2a, objectName_signal2a, timeStampArray_signal2a, channelNumberArray_signal2a, samplingFreqArray_signal2a, numValidSamplesArray_signal2a, dataArray_signal2a, numRecordsReturned_signal2a, numRecordsDropped_signal2a ] = calllib('MatlabNetComClient', 'GetNewCSCData', objectName2, timeStampArrayPtr, channelNumberArrayPtr, samplingFreqArrayPtr, numValidSamplesArrayPtr, dataArrayPtr, numRecordsReturnedPtr,numRecordsDroppedPtr );
        timeStampArray_signal2     = [timeStampArray_signal2, timeStampArray_signal2a];
        samplingFreqArray_signal2  = [samplingFreqArray_signal2, samplingFreqArray_signal2a];
        dataArray_signal2          = [dataArray_signal2, dataArray_signal2a];
        numRecordsReturned_signal2 = [numRecordsReturned_signal2+numRecordsReturned_signal2a]; 
        numRecordsDropped_signal2  = [numRecordsDropped_signal2+numRecordsDropped_signa2a];    
