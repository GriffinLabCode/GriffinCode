...
function [coh,timeConv] = highCoherenceLongDuration(LFP1name,LFP2name,delay_length,looper,amountOfData,s,doorFuns,params,srate,threshold,tStart)
...
for i = 1:looper
    ...
    if coh(i) >= threshold.high_coherence_magnitude % < bc this is low coh
        ...
        % are met
        if dur_sum >= threshold.high_coherence_longDuration
