...
function [SWRcount,SWRdurations,SWRtimes,SWRtimeIdx] = extract_SWR_4(lfp,mazeLoc,Int,Timestamps,srate,phase_bandpass,std_above_mean,gauss,InterRippleInterval,plotFig)
