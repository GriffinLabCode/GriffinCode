...
function [SWRevents,SWRtimes,SWRtimeIdx,SWRdurations,Int_new] = extract_SWR_4(preSWRlfp,mazeLoc,Int,Timestamps,srate,phase_bandpass,std_above_mean,gauss,InterRippleInterval,plotFig)
...
% remove trials with no events
idxRem2         = find((~cellfun('isempty',swr_events))==0);
