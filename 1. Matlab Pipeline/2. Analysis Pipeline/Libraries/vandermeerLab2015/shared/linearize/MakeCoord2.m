function Coord = MakeCoord2(x, y, stemX, stemY, meas_distance, varargin)
...
Coord_temp = newPoints;

% interpolate to measured distance
Coord = [];
interp_var = linspace(1,length(Coord_temp(1,:)),meas_distance);
Coord(1,:) = interp1(1:length(Coord_temp(1,:)),Coord_temp(1,:),interp_var,'spline');
Coord(2,:) = interp1(1:length(Coord_temp(2,:)),Coord_temp(2,:),interp_var,'spline');
