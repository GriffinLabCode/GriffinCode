...
coordL = MakeCoord(X,Y,'titl','Draw left trajectory, press enter when done','XDir','reverse');
coordR = MakeCoord(X,Y,'titl','Draw right trajectory, press enter when done','XDir','reverse');
...
figure; plot(X,Y,'.','Color',[0.7 0.7 0.7],'MarkerSize',4); set(gca,'XDir','reverse'); hold on;
...
load(strcat(directory,'\Int_file.mat'))
