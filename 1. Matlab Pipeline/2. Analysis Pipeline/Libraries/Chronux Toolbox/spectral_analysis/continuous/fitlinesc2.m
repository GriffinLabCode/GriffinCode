function [datafit,Amps,freqs,Fval,sig]=fitlinesc2(data,params,p,plt,f0)
...
%        end;
   ...
   %indx = zeros( length(f0) ); % I (JS) removed this line as it gave
   %issues with manual definition of noise band with single vector data
   for n=1:length(f0);
