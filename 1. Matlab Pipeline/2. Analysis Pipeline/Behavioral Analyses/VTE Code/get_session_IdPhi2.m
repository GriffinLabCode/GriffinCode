...
function [IdPhi,x_data,y_data,ts_data,ExtractedX,ExtractedY,TimeStamps,timeSpent] = get_session_IdPhi2(datafolder,ExtractedX,ExtractedY,TimeStamps,Int,middleStemPosition,stemOrientation,preSmooth,mazeLoc)
