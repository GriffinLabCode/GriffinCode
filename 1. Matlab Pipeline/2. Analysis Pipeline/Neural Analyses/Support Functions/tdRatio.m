...
function [theta_delta_rat] = tdRatio(LFP,srate)

% -- FOR THETA -- %

% phase bandpass
phase_bandpass_theta = [6 10]; %[6 12];
...
theta_delta_rat = mean(inst_theta_power./inst_delta_power); % theta / delta - was delta/theta - JS change on 8/6/20
