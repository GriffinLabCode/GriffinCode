...
%
% INPUTS: pos_x - ExtractedX data from VT1.mat
%         pos_y - ExtractedY data from VT1.mat
%         pos_t - TimeStamps_VT data from VT1.mat
%         datafolder - string variable containing directory
%
% OUTPUTS: Int file
%

function [Int] = whereishe_master(pos_x,pos_y,pos_t,datafolder)
...
pos_x = ExtractedX; pos_y = ExtractedY; 
