...
elseif  contains(startbox,[{'n'} {'N'}])
    ...
    % remove the last stem entry as it was the final return
    stem_entry(end) = [];
    % clear out the startbox variable as it was not used 
    startBox_entry = NaN([size(stem_entry)]);    
end
