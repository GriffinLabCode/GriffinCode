...
%% CHECK YOUR DATA!!!
[remStem2Choice, remReturn, remDelay] = checkInt(Int_old,x,y,t);
...
% generate table
IntTable = table(trajNumber,stemEntry,cpEntry,gaEntry,gzEntry,retEntry,sbEntry,trajectory,accuracy,trajBinary,accBinary,delayTime,trackingErrorStem,trackingErrorReturn,trackingErrorSBentry,failedTimeStamp);
