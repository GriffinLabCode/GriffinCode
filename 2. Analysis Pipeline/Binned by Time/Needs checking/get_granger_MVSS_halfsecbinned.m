...
input.target_sample = 500; % this needs to be at least 500 for half second epochs
        ...
        for lagi = 1:5
           ...
           for i = 1:2
               if i == 1
                   ...
                   [fx2y.sam{lagi}{nn-2},fy2x.sam{lagi}{nn-2},freqs.sam{lagi}{nn-2},~,fx2z.sam{lagi}{nn-2},fz2x.sam{lagi}{nn-2},fy2z.sam{lagi}{nn-2},fz2y.sam{lagi}{nn-2}] = StateSpaceGranger(data,ssmo{nn-2},pf{nn-2});                   
               ...
               elseif i == 2
                   ...
                   data.num_trials       = size(data.signals,3);
                   data.num_observations = size(data.signals,2); 
                   [fx2y.cho{lagi}{nn-2},fy2x.cho{lagi}{nn-2},freqs.cho{lagi}{nn-2},~,fx2z.cho{lagi}{nn-2},fz2x.cho{lagi}{nn-2},fy2z.cho{lagi}{nn-2},fz2y.cho{lagi}{nn-2}] = StateSpaceGranger(data,ssmo{nn-2},pf{nn-2});                   
                   
                   %[fx2y.cho{nn-2},fy2x.cho{nn-2},freq.cho{nn-2}] = StateSpaceGranger(data,ssmo{nn-2},pf{nn-2});
               end
           end
           clear signal data signalx signaly signalz signalx_cle signalx_det ...
               signaly_cle signaly_det signalz_cle signalz_det signalx_raw signaly_raw signalz_raw ...
               lag_t
