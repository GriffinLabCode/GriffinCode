...
figure('color','w'); hold on;
shadedErrorBar(freqs,mean(phaseNormHighS,1),stderr(phaseNormHighS,1),'k',0);
shadedErrorBar(freqs,mean(phaseNormLowS,1),stderr(phaseNormLowS,1),'r',0);
...
phaseCohMatLow_theta  = mean(phaseNormLowS(:,idxTheta),2);
figure('color','w')
