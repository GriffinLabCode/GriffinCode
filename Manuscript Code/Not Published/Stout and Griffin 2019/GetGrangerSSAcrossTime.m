    ...
    %% get granger estimates
        ...
        for triali = 1:size(Int,1)
            ...
            time = [];
                ...
                if k == 1
                  time = [(Int(triali,5)-(3*1e6)) (Int(triali,5)-(2*1e6))]; 
                elseif k == 2 
            ...
            %{
            if k == 1
              time = [(Int(triali,5)-(3*1e6)) (Int(triali,5)-(2.5*1e6))]; 
            elseif k == 2 
              time = [(Int(triali,5)-(2.5*1e6)) (Int(triali,5)-(2*1e6))]; 
            elseif k == 3
            ...
            if input.target_sample ~= 0     
                ...
                signalx{triali}=signalx_cle{triali}(1:div:end);
                signaly{triali}=signaly_cle{triali}(1:div:end);
                signalz{triali}=signalz_cle{triali}(1:div:end);
