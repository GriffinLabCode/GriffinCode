...
function [pos_X,pos_Y,times,ExtractedX,ExtractedY] = rat_locationPosition(datafolder,Int)
        ...
        for triali=1:size(Int,1) % trial
            ...
            ts_Temp   = TimeStamps_VT(TimeStamps_VT > time(1,1) & TimeStamps_VT < time(1,2));
