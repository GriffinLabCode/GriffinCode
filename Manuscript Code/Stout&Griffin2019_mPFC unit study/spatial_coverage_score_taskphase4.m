...
function [coverage_sample,coverage_choice] = spatial_coverage_score_taskphase3(datafolder,Int,ExtractedX,ExtractedY,TimeStamps,spk,clusters,peak_rate)   
...
choice_trials = 2:2:size(Int,1);
    ...
    clearvars -except sample_trials coverage_sample peak_rate_sample ...
        ...
        threshold_choice threshold_sample threshold peak_rate
