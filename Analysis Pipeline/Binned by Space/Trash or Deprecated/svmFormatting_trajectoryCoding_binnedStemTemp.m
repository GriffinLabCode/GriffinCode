...
function [FRdata] = svmFormatting_trajectoryCoding_binnedStemTemp(Datafolders,int_name,vt_name,task_type,stem_dir,numbins)
    ...
    for nn = 3:length(folder_names)%([3:15,29:length(folder_names)])%3:length(folder_names)
