...
function [FRdata] = svmFormatting_taskPhaseCoding_binnedStemTemp(Datafolders,int_name,vt_name,task_type,stem_dir,numbins,correct)
    ...
    for nn = %(16:28)%([3:15,29:length(folder_names)]) %length(folder_names)
