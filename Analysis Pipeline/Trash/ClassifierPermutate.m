...
function [p,svm_perf,svm_sem,shuff_mean,svm_perf_rand] = ClassifierPermutate(svm_cell,permute_data,permute_labels,leave1out,pseudosimult,individual)
...
if pseudosimult == 1
    for ii = 1:length(svm_cell)
        if permute_data == 1
            ...
            elseif leave1out == 1 && downsample_data == 0
            ...
            elseif leave1out == 1 && downsample_data == 0
                ...
                % this is currently not flexible
        ...
        elseif permute_labels == 1
            ...
            for n = 1:1000
               ...
               % shuffle
               perm_idx1 = randperm(size(data,1)/2);
               perm_idx2 = randperm(size(data,1)/2);       
               % get labels
